...
signup_entry_email.place(x=325, y=255, width=250, height=30)

signup_entry_username = Entry(signup_frame, bd=0, bg="#d9d9d9", highlightthickness=0)
signup_entry_username.place(x=325, y=325, width=250, height=30)

signup_entry_password = Entry(signup_frame, bd=0, bg="#d9d9d9", highlightthickness=0)
signup_entry_password.place(x=325, y=395, width=250, height=30)
...
register_button = Button(signup_frame, image=img_reg, borderwidth=0, highlightthickness=0, relief="flat", bg="#d9d9d9")
...
login_entry_username.place(x=325, y=265, width=250, height=30)

login_entry_password = Entry(login_frame, bd=0, bg="#d9d9d9", highlightthickness=0)
login_entry_password.place(x=325, y=345, width=250, height=30)
...
# Create and place buttons
login0_button = Button(login_frame, image=img_log0, borderwidth=0, highlightthickness=0, relief="flat", bg="#d9d9d9")
